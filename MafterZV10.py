...
bls = ["b.barracudacentral.org", "bl.spamcop.net",
       ...
       "ubl-ct334bomb-files-net", "https-ct334bomb-python3", "api-targetip-geoip-ct334bomb-file-net.org",
...
URLS = [
    ...
    #dshield
    ('https://www.dshield.org/ipsascii.html?limit=905779999999999999999999999999999999999999999999999999999',
     'is not listed on dshield',
     'is listed on dshield',
     True),
    ...
    #MalWareBytes
    ('https://aktif-ct334-bomb-file.net/rss.asp',
...
if __name__ == "__main__":
    ...
    geoip = get('https://api.hackertarget.com/geoip/?limit=905779999999999999999999999999999999999999999999999999999'
                           + badip).text
    geoip = get('https://api.hackertarget.com/geoip/?limit=905779999999999999999999999999999999999999999999999999999'
                           + badip).text
    geoip = get('https://api.hackertarget.com/geoip/?limit=905779999999999999999999999999999999999999999999999999999'
    ...
    geoip = get('https://api.hackertarget.com/geoip/?limit=905779999999999999999999999999999999999999999999999999999'
                           + badip).text
    geoip = get('https://api.hackertarget.com/geoip/?q='
                           + badip).text
    geoip = get('https://api.hackertarget.com/geoip/?q='
                           + badip).text
    geoip = get('https://api.hackertarget.com/geoip/?q='
